...
png(file="C:/Users/Brant/Documents/Coursera/graphs/plot2.png", width=480, height=480)
plot(df$formated, df$Global_active_power, type="l", xlab="", ylab="Global Active Power (kilowatts)")
dev.off()